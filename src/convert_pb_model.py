...
def covert_pb_to_server_model(pb_model_path, export_dir, input_name='input:0', output_name='embeddings:0'):
    ...
    with tf.Session(graph=tf.Graph()) as sess:
        ...
        sigs[signature_constants.DEFAULT_SERVING_SIGNATURE_DEF_KEY] = \
            tf.saved_model.signature_def_utils.predict_signature_def(
                {"input": inp, 'phase_train': phase_train_placeholder}, {"output": out})
...
covert_pb_to_server_model('20180402-114759/20180402-114759.pb', 'facenet_model')
